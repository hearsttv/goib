...
func (m *API) Entry(channel string, entrytype string, params url.Values) (interface{}, error) {
...
func (m *API) Content(channel string, contentID int, params url.Values) (interface{}, error) {
	ret := m.Called(channel, contentID, params)
